...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='document',
            field=models.FileField(upload_to='pages', validators=[bluebottle.utils.validators.FileMimetypeValidator(['application/pdf', 'application/zip', 'image/jpeg', 'image/png', 'image/gif', 'application/vnd.openxmlformats-officedocument.presentationml.presentation', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document'], None, 'invalid_mimetype')], verbose_name='Document'),
        ),
        migrations.AlterField(
